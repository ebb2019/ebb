...
//	 * @param fileName
//	 */
//	private static void testUploadVideo(String accessKeyId,
//			String accessKeySecret, String title, String fileName) {
...
//		/*
//		 * 是否开启断点续传,
//		 * 默认断点续传功能关闭。当网络不稳定或者程序崩溃时，再次发起相同上传请求，可以继续未完成的上传任务，适用于超时3000秒仍不能上传完成的大文件
...
//	 * @param accessKeySecret
//	 */
//	private static void testUploadImageLocalFile(String accessKeyId,
