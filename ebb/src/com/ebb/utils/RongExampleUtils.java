...
public class RongExampleUtils {
    ...
    public void setUp() throws Exception {
        String appKey = "mgb7ka1nmd5rg";
        String appSecret = "r3vIhDtPr7z";
    ...
    public void testSendSystemTemplate() throws Exception {
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(RongExampleUtils.class.getClassLoader().getResourceAsStream("jsonsource/message/TemplateMessage.json")));
